...
<body>
  <header>
        ...
        <div class="buscador-container">
          <input type="text" id="buscador" placeholder="Buscar producto..." aria-label="Buscar producto">
          ...
          <div id="resultados">
            <ul id="lista-resultados" style= "list-style: none;">
            </ul>

            <button class="btn-cerrar" onclick="cerrarBuscador()">Cerrar</button>
          </div>
        </div>
